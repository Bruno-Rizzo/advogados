...
Route::middleware('auth')->group(function () {
    ...
    Route::controller(ReportController::class)->group(function(){
        ...
        Route::post('/reports/book/date',             'book_date')              ->name('reports.book_date');
    });

    Route::controller(ResearchController::class)->group(function(){

        Route::get('/researchs',               'index')  ->name('researchs.index');
        Route::post('/researchs',              'search') ->name('researchs.search');
        Route::get('/researchs/{book}/edit',   'edit')   ->name('researchs.edit');
        Route::put('/researchs/{book}/update', 'update') ->name('researchs.update');
    });
