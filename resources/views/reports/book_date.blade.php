...
<body>
    ...
    <h3 style="text-align: center; color:gray">Livro de Visita de Advogados</h3>
    <span style="font-size:14px; color:gray; margin-right:56%">Unidade Prisional: {{$up->name}}</span>
    <span class="text" style="font-size:14px; color:gray;">Data: {{Carbon\Carbon::parse($date)->format('d/m/Y')}}</span>
    ...
    <table width="100%" class="table" style="margin-top: 10px">
        <thead>
          <tr>
            ...
            <th style="text-align: center; width:13%">ID Servidor</th>
        ...
        <tbody>
          @foreach ($data as $item)
            <tr>
                ...
                <td style="text-align: center">{{$item->user->identify}}</td>
                <td>
      ...
      @if($item->observations)
        ...
        <div style="margin-top: 10px;">
            ...
            <textarea rows="2" style="width:100%">{{$item->observations}}</textarea>
        </div>
